...
def convert_yolo_to_coco(yolo_folder, output_json_path):
    ...
    coco_data["categories"].append({"id": 1, "name": "category1", "supercategory": "object"})
    coco_data["categories"].append({"id": 2, "name": "category2", "supercategory": "object"})
...
# trainデータを変換
convert_yolo_to_coco("dice/train2017", "dice/annotations/instances_train2017.json")
# valデータを変換
convert_yolo_to_coco("dice/val2017", "dice/annotations/instances_val2017.json")